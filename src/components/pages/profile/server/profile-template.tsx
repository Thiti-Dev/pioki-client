...
export default async function ProfileServerTemplate({name,pictureURL,children}: {name: string,userID: string,pictureURL: string,children?: ReactNode}){
    return <>
    <div className="w-screen h-screen bg-gray-50 flex flex-row">
        <div className={`bg-gray-800 h-screen min-w-[400px] pt-20 ${workBench.className}`}>
            ...
            <NextImage alt="profile-image" className="rounded-full bg-red-500" width={250} height={250} src={pictureURL}/>
                {/* <img className="w-24 h-24 mb-3 rounded-full shadow-lg" src="/docs/images/people/profile-picture-3.jpg" alt="Bonnie image"/> */}
                <h5 className="mb-1 text-3xl font-medium text-gray-900 dark:text-white">{name}</h5>
