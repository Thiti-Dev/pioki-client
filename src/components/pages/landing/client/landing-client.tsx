...
function initailize(flag: MutableRefObject<boolean>,cb: () => void){
    return useLayoutEffect(() => {
        if(!flag.current){
            ...
            image.src = 'https://www.hdwallpapers.in/download/artistic_landscape_mountains_trees_sunset_purple_sky_background_minimalist_hd_minimalism-1600x900.jpg';
            image.onload = () => {
...
export default function LandingClient(){
    ...
    return (
        <div className="bg-stone-200 pt-5 pr-2 pl-2 flex flex-col items-center sm:block">
            ...
            <p className="mt-[200rem]">Landing client part</p>
        </div>
    )
}